"""
URL configuration for exercise_django_middlewares_sessions project.
...
from exercise_django_middlewares_sessions import views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('choose_language/', views.choose_language, name='choose-language'),
